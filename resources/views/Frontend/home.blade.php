        ...
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-8" data-aos="fade-up" data-aos-delay="200">
                ...
                <p><a href="{{ route('TourPackage') }}" class="btn btn-primary py-3 px-5 text-white">Our Tour Package</a></p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
        ...
        @foreach($TourPackage as $TourPackages)
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <a href="{{ route('package-details', $TourPackages->id) }}" class="unit-1 text-center">
